...
public class CompareMain {
    ...
    public static void main(String[] args) {
        ...
        firstList.add(new Account(1, "first account", new BigDecimal(200), ZonedDateTime.parse("2010-04-06T16:01:00.000+03:00")));
        firstList.add(new Account(2, "second account", new BigDecimal(500), ZonedDateTime.parse("2018-04-06T16:01:00.000+03:00")));
